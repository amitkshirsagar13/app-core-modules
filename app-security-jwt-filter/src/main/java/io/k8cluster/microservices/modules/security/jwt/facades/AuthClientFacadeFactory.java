package io.k8cluster.microservices.modules.security.jwt.facades;

import io.k8cluster.microservices.modules.exception.AppException;
import io.k8cluster.microservices.modules.security.jwt.config.AuthProviderType;
...
public class AuthClientFacadeFactory {
    ...
    private final static Map<AuthProviderType, Function<OAuthConfig, io.k8cluster.microservices.modules.security.jwt.facades.AuthClientFacade>> clients = new HashMap<>();

    static {
        clients.put(AuthProviderType.AUTH0, io.k8cluster.microservices.modules.security.jwt.facades.Auth0ClientFacade::new);
        clients.put(AuthProviderType.APP, AppClientFacade::new);
        clients.put(AuthProviderType.SELFSIGNED, io.k8cluster.microservices.modules.security.jwt.facades.SelfSignedClientFacade::new);
    }

    public static io.k8cluster.microservices.modules.security.jwt.facades.AuthClientFacade createClient(String tenantName, OAuthConfig authConfig) {
