package io.k8cluster.microservices.modules.security.jwt.config;
...
public class OAuthApplicationsConfig {
    ...
    private io.k8cluster.microservices.modules.security.jwt.config.AuthProviderType defaultAuthType;

    @JsonProperty(required = true)
    private Map<String, io.k8cluster.microservices.modules.security.jwt.config.OAuthConfig> applications = new HashMap<>();

    public io.k8cluster.microservices.modules.security.jwt.config.OAuthConfig getAppAuthConfig() {
