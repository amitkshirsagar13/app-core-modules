...
import io.k8cluster.microservices.modules.security.jwt.config.SwaggerUISecurityConfig;
import io.k8cluster.microservices.modules.security.jwt.config.AppConfig;
...
import io.k8cluster.microservices.modules.security.jwt.helpers.YamlPropertyLoaderFactory;
...
public class SecurityTokenConfig extends WebSecurityConfigurerAdapter {
    ...
    @Configuration
    @Order(1)
    public static class SwaggerActuatorBasicSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Configuration
    @Order(3)
    public class HystrixNoAuthSecurityConfig extends WebSecurityConfigurerAdapter {
        @Override
